...
//        textView.setTypeface(CFProvider.getIRANIANSANS(getActivity()));
        for (int i = 0; i <5 ; i++) {
            if (i == 0) {
                SliderArray.add(ContextCompat.getDrawable(getActivity(),R.drawable.yariabad));
            }else if (i == 1) {
                SliderArray.add(ContextCompat.getDrawable(getActivity(),R.drawable.yariabad_1));
            }else if (i == 2) {
                SliderArray.add(ContextCompat.getDrawable(getActivity(),R.drawable.yariabad_2));
            }else if (i == 3) {
                SliderArray.add(ContextCompat.getDrawable(getActivity(),R.drawable.yariabad_3));
            }
        }

 ...
 */
public class ZiaAbad_Haft extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_zia_abad__haft, container, false);
        mPager = view.findViewById(R.id.MarkaziHaft_Pager);
        indicator = view.findViewById(R.id.MarkaziHaft_Indigator);
//        textView = view.findViewById(R.id.TourismServices_Text);
//        textView.setTypeface(CFProvider.getIRANIANSANS(getActivity()));
        for (int i = 0; i <3 ; i++) {
            if (i == 0) {
                SliderArray.add(ContextCompat.getDrawable(getActivity(),R.drawable.haft));
            }else if (i==1) {
                SliderArray.add(ContextCompat.getDrawable(getActivity(),R.drawable.haft_1));
            }
        }

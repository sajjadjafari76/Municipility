...
public class Markazi_Khondo extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_markazi__khondo, container, false);
        mPager = view.findViewById(R.id.MarkaziKhondo_Pager);
        indicator = view.findViewById(R.id.MarkaziKhondo_Indigator);
//        textView = view.findViewById(R.id.TourismServices_Text);
//        textView.setTypeface(CFProvider.getIRANIANSANS(getActivity()));
        for (int i = 0; i <3 ; i++) {
            if (i == 0) {
                SliderArray.add(ContextCompat.getDrawable(getActivity(),R.drawable.khondo));
            }else if (i==1){
                SliderArray.add(ContextCompat.getDrawable(getActivity(),R.drawable.khondo_1));
            }
        }

 ...
 */
public class Handicrafts_GhoflSazi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_handicrafts__ghofl_sazi, container, false);
        mPager = view.findViewById(R.id.GhoflSazi_Pager);
        indicator = view.findViewById(R.id.GhoflSazi_Indigator);
//        textView = view.findViewById(R.id.TourismServices_Text);
//        textView.setTypeface(CFProvider.getIRANIANSANS(getActivity()));
        for (int i = 0; i < 1; i++) {
            if (i == 0) {
                SliderArray.add(ContextCompat.getDrawable(getActivity(), R.drawable.ghoflsazi));
            }
        }

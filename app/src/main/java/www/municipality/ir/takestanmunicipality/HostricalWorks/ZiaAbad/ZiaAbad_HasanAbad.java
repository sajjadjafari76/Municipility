 ...
 */
public class ZiaAbad_HasanAbad extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_zia_abad__hasan_abad, container, false);
        mPager = view.findViewById(R.id.MarkaziHasanAbad_Pager);
        indicator = view.findViewById(R.id.MarkaziHasanAbad_Indigator);
//        textView = view.findViewById(R.id.TourismServices_Text);
//        textView.setTypeface(CFProvider.getIRANIANSANS(getActivity()));
        for (int i = 0; i < 5; i++) {
            if (i == 0) {
                SliderArray.add(ContextCompat.getDrawable(getActivity(), R.drawable.hasanabad));
            } else if (i == 1) {
                SliderArray.add(ContextCompat.getDrawable(getActivity(), R.drawable.hasanabad_1));
            }
        }
